...
# this class represents a node, essentially
class Spot:
...
# simple manhattan or taxicab distance function
def distance_function(p1, p2):
    # split the variables into their components
    x1, y1 = p1
    x2, y2 = p2
...
# this function constructs our grid of Spot instances
